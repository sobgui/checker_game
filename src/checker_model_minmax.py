...
class CheckerModelMinMax:
    ...
    def move_piece(self, checker_model, depth=3, to_maximize=False):
        selected_piece_position, move_position = self.get_best_move(checker_model, depth, to_maximize=to_maximize)
        checker_model.move_piece(selected_piece_position, move_position)

    def get_best_move(self, checker_model, depth, to_maximize=False):
        ...
        for possible_action in possible_actions:
            ...
            score = self.minmax(checker_model=checker_model, robot_turn=False, depth=depth, to_maximize=to_maximize)
    ...
    def minmax(self, checker_model, robot_turn, depth=3, alpha=-float('inf'), beta=float('inf'), to_maximize=False):
